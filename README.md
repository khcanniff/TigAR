...
##### Now that the Mapbox custom was created the next step was implmenting Mapbox into Unity. After importing the Mapbox package into Unity, there was a various prefabs in the asset folders. 
